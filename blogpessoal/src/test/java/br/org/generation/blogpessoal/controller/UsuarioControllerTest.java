...
public class UsuarioControllerTest {
	...
	@Test
	@Order(2)
	@DisplayName("Nao deve permtir duplicação do Usuario")
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario(0L,"Juliana Andews","juliana_andrews@email.com.br","juliana123"));
		
		Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(),"Juliana Andews","juliana_andrews@email.com.br","juliana123");
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,"Sabrina Sanches", "sabrina_sanches@email.com.br","sariana123"));
